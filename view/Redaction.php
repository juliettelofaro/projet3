...
if(isset($_SESSION['idutilisateur'])) 
 ...
 <form method="post" action="?actionajouter=ajouter">
		   
		        <p style="font-size: 17px; color:black;" >  Titre de l'article : <input type="text" name="titre" required></textarea></p>  
		       	<pre data-codetype=" " style="width:95%; display:inline-block;border-color:#008080; border-style:dotted;  background-color:#008080;""></br>
 <textarea name="contenu" id="a" cols="50" rows="15"></textarea> <p align="right"><input type="submit" value="Enregistrer" /></p>	   
</pre>
